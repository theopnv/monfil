...
const feedA: NewFeedInput = {
  ...
  title: 'Feed A',
  items: [{ title: 'Item 1', link: 'https://a.example/feed#1', pubDate: '2024-01-01', description: '', image: undefined }],
  categoryName: 'tech',
  showInHome: true,
};
const feedB: NewFeedInput = {
  ...
  title: 'Feed B',
  items: [{ title: 'Item 1', link: 'https://b.example/feed#1', pubDate: '2024-01-01', description: '', image: undefined }],
  categoryName: 'tech',
  showInHome: true,
};
