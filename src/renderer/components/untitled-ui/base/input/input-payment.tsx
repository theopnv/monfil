...
import type { InputProps } from "@/components/untitled-ui/base/input/input";
import { InputBase, TextField } from "@/components/untitled-ui/base/input/input";
import { Label } from "@/components/untitled-ui/base/input/label";
import { AmexIcon, DiscoverIcon, MastercardIcon, UnionPayIcon, VisaIcon } from "@/components/untitled-ui/foundations/payment-icons";
...
const detectCardType = (number: string) => {
    ...
    return card || (cardTypes[cardTypes.length - 1] as (typeof cardTypes)[number]);
};
